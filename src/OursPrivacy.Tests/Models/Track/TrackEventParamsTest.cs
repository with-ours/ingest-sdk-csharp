...
public class TrackEventParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new TrackEventParams
        {
            Token = "x",
            Event = "x",
        ...
        Assert.Equal(expectedDistinctID, parameters.DistinctID);
        Assert.Equal(expectedEmail, parameters.Email);
        Assert.NotNull(parameters.EventProperties);
        Assert.Equal(expectedEventProperties.Count, parameters.EventProperties.Count);
        foreach (var item in expectedEventProperties)
        {
            Assert.True(parameters.EventProperties.TryGetValue(item.Key, out var value));
    ...
    public void OptionalNullableParamsUnsetAreNotSet_Works()
    {
        ...
        Assert.Null(parameters.UserProperties);
        Assert.False(parameters.RawBodyData.ContainsKey("userProperties"));
    }
    ...
    public void OptionalNullableParamsSetToNullAreSetToNull_Works()
    {
        ...
        Assert.Null(parameters.DistinctID);
        Assert.True(parameters.RawBodyData.ContainsKey("distinctId"));
        Assert.Null(parameters.Email);
        ...
        Assert.Null(parameters.UserProperties);
        Assert.True(parameters.RawBodyData.ContainsKey("userProperties"));
    }

    [Fact]
    public void Url_Works()
    {
        TrackEventParams parameters = new() { Token = "x", Event = "x" };
    ...
    public void CopyConstructor_Works()
    {
        ...
        TrackEventParams copied = new(parameters);
