...
public class VisitorUpsertResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new VisitorUpsertResponse { Success = Success.True };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<VisitorUpsertResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        VisitorUpsertResponse copied = new(model);
