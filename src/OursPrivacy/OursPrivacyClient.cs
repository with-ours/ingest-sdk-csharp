...
/// <inheritdoc/>
public sealed class OursPrivacyClient : IOursPrivacyClient
{
    ...
    readonly Lazy<IOursPrivacyClientWithRawResponse> _withRawResponse;

    /// <inheritdoc/>
    public IOursPrivacyClientWithRawResponse WithRawResponse
    {
        get { return _withRawResponse.Value; }
    }

    /// <inheritdoc/>
    public IOursPrivacyClient WithOptions(Func<ClientOptions, ClientOptions> modifier)
    {
    ...
    readonly Lazy<IVisitorService> _visitor;
    public IVisitorService Visitor
    {
        get { return _visitor.Value; }
    }

    readonly Lazy<IExperimentService> _experiments;
    public IExperimentService Experiments
    {
    ...
    public OursPrivacyClient()
    {
        ...
        _experiments = new(() => new ExperimentService(this));
    }
...
/// <inheritdoc/>
public sealed class OursPrivacyClientWithRawResponse : IOursPrivacyClientWithRawResponse
{
#if NET
    ...
    /// <inheritdoc/>
    public IOursPrivacyClientWithRawResponse WithOptions(
    ...
    readonly Lazy<IVisitorServiceWithRawResponse> _visitor;
    public IVisitorServiceWithRawResponse Visitor
    {
        get { return _visitor.Value; }
    }

    readonly Lazy<IExperimentServiceWithRawResponse> _experiments;
    public IExperimentServiceWithRawResponse Experiments
    {
        get { return _experiments.Value; }
    }
        ...
        where T : ParamsBase
    {
        ...
        while (true)
        {
            ...
            if (response != null && (++retries > maxRetries || !ShouldRetry(response)))
            {
                ...
                try
                {
                    throw OursPrivacyExceptionFactory.CreateApiException(
                        response.StatusCode,
                ...
                {
                    throw new OursPrivacyIOException("I/O Exception", e);
                }
                finally
                {
                    response.Dispose();
    ...
    {
        return e is IOException || e is OursPrivacyIOException;
    }

    public void Dispose() => this.HttpClient.Dispose();

    public OursPrivacyClientWithRawResponse()
    {
        _options = new();
        ...
        _experiments = new(() => new ExperimentServiceWithRawResponse(this));
    }
