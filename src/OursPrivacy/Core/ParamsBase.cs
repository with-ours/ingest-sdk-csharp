...
public abstract record class ParamsBase
{
    ...
    static ParamsBase()
    {
        ...
        var customHeadersEnv = Environment.GetEnvironmentVariable("OURS_PRIVACY_CUSTOM_HEADERS");
    ...
    static string GetUserAgent() => $"{typeof(OursPrivacyClient).Name}/C# {GetPackageVersion()}";
