...
public class HttpResponse : IDisposable
{
    ...
    {
        if (obj is not global::OursPrivacy.Core.HttpResponse other)
        {
            return false;
        }
    ...
    public async Task<T> Deserialize<T>(Threading::CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            return await JsonSerializer
                ...
                ?? throw new OursPrivacyInvalidDataException("Response cannot be null");
        }
...
public sealed class HttpResponse<T> : global::OursPrivacy.Core.HttpResponse
{
    ...
    internal HttpResponse(
        global::OursPrivacy.Core.HttpResponse response,
...
public sealed class StreamingHttpResponse<T> : global::OursPrivacy.Core.HttpResponse
{
