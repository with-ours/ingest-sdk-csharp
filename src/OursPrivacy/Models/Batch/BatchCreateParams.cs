...
#pragma warning restore CS8618
    ...
    {
        return new UriBuilder(options.BaseUrl.ToString().TrimEnd('/') + "/batch")
        {
...
public sealed record class Event : JsonModel
{
    ...
    public IdentityContext? IdentityContext
    {
        ...
        {
            this._rawData.Freeze();
            return this._rawData.GetNullableClass<IdentityContext>("identityContext");
        }
        init { this._rawData.Set("identityContext", value); }
    }
    ...
    public double? Time
    {
        ...
        {
            this._rawData.Freeze();
            return this._rawData.GetNullableStruct<double>("time");
        }
    ...
    public UserProperties? UserProperties
    {
        ...
        {
            this._rawData.Freeze();
            return this._rawData.GetNullableClass<UserProperties>("userProperties");
        }
        init { this._rawData.Set("userProperties", value); }
    }
