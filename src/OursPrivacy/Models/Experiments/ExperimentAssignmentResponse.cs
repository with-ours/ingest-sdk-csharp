...
[JsonConverter(typeof(ExperimentAssignmentResponseConverter))]
public record class ExperimentAssignmentResponse : ModelBase
{
    ...
    public ExperimentAssignmentResponse(UnionMember0 value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public ExperimentAssignmentResponse(UnionMember1 value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public ExperimentAssignmentResponse(JsonElement element)
    {
        this._element = element;
    }
        ...
        switch (this.Value)
        {
            ...
            default:
                throw new OursPrivacyInvalidDataException(
                    "Data did not match any variant of ExperimentAssignmentResponse"
                );
        }
    }
    ...
    public static implicit operator ExperimentAssignmentResponse(UnionMember0 value) => new(value);

    public static implicit operator ExperimentAssignmentResponse(UnionMember1 value) => new(value);
    ...
    public virtual bool Equals(ExperimentAssignmentResponse? other) =>
        other != null
...
sealed class ExperimentAssignmentResponseConverter : JsonConverter<ExperimentAssignmentResponse>
{
    public override ExperimentAssignmentResponse? Read(
    ...
    public override void Write(
        ...
        ExperimentAssignmentResponse value,
        JsonSerializerOptions options
    )
    {
...
public sealed record class UnionMember0 : JsonModel
{
    ...
    public required ApiEnum<bool, InExperiment> InExperiment
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullClass<ApiEnum<bool, InExperiment>>("in_experiment");
        }
        init { this._rawData.Set("in_experiment", value); }
    }
    ...
    public bool? IsControl
    {
        ...
        {
            this._rawData.Freeze();
            return this._rawData.GetNullableStruct<bool>("is_control");
        }
...
[JsonConverter(typeof(InExperimentConverter))]
public enum InExperiment
{
    True,
}

sealed class InExperimentConverter : JsonConverter<InExperiment>
{
    public override InExperiment Read(
        ref Utf8JsonReader reader,
        Type typeToConvert,
        JsonSerializerOptions options
    )
...
{
    public required ApiEnum<bool, UnionMember1InExperiment> InExperiment
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullClass<ApiEnum<bool, UnionMember1InExperiment>>(
                "in_experiment"
            );
        }
        init { this._rawData.Set("in_experiment", value); }
...
[JsonConverter(typeof(UnionMember1InExperimentConverter))]
public enum UnionMember1InExperiment
{
    False,
}

sealed class UnionMember1InExperimentConverter : JsonConverter<UnionMember1InExperiment>
{
    public override UnionMember1InExperiment Read(
        ref Utf8JsonReader reader,
        Type typeToConvert,
        JsonSerializerOptions options
    )
    {
        return JsonSerializer.Deserialize<bool>(ref reader, options) switch
        {
            false => UnionMember1InExperiment.False,
            _ => (UnionMember1InExperiment)(-1),
        };
    }

    public override void Write(
        Utf8JsonWriter writer,
        UnionMember1InExperiment value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                UnionMember1InExperiment.False => false,
                _ => throw new OursPrivacyInvalidDataException(
                    string.Format("Invalid value '{0}' in {1}", value, nameof(value))
                ),
            },
