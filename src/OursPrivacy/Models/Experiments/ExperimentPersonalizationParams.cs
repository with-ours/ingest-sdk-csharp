...
/// </summary>
public record class ExperimentPersonalizationParams : ParamsBase
{
    ...
    public ExperimentPersonalizationParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public ExperimentPersonalizationParams(
        ExperimentPersonalizationParams experimentPersonalizationParams
    )
        : base(experimentPersonalizationParams)
    {
        this._rawBodyData = new(experimentPersonalizationParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public static ExperimentPersonalizationParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, JsonElement> rawBodyData
    )
    ...
    public virtual bool Equals(ExperimentPersonalizationParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    public override Uri Url(ClientOptions options)
    {
        return new UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/') + "/experiments/personalization"
        )
        {
